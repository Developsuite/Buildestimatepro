        ...
        <div className="max-w-7xl 2xl:max-w-[90rem] w-full mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-md px-3 py-2 sm:px-5 sm:py-2.5 rounded-full border border-white/20 mb-4 sm:mb-6 hover:bg-white/15 transition-all mx-auto lg:mx-0">
                <div className="flex items-center gap-1 sm:gap-2">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#E8481C] rounded-full animate-pulse"></div>
                  <span className="text-[#E8481C] font-bold text-base sm:text-lg">25+</span>
                </div>
                <div className="h-4 sm:h-6 w-px bg-white/30"></div>
                <span className="text-white text-xs sm:text-sm font-medium">Years Experience</span>
              </div>

              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-white mb-4 sm:mb-6 font-figtree leading-[1.1]">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 mb-6 sm:mb-8 md:mb-10 leading-relaxed font-figtree max-w-xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 sm:gap-4 mb-8">
                <Link
                  href="/contact"
                  className="group relative w-full sm:w-auto px-4 py-2 sm:px-8 sm:py-4 bg-[#E8481C] text-white font-semibold rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#E8481C]/50 font-figtree text-center"
                >
                ...
                <Link
                  href="/contact"
                  className="group relative w-full sm:w-auto px-4 py-2 sm:px-8 sm:py-4 bg-white text-[#E8481C] font-semibold rounded-lg border-2 border-white hover:border-[#E8481C] overflow-hidden transition-all duration-300 hover:scale-105 font-figtree text-center"
                >
                  <span className="relative z-10 text-xs sm:text-base">Contact Us</span>
                  <div className="absolute inset-0 bg-[#E8481C]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </Link>
              </div>

              {/* Trust Indicators */}
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-6 text-white/70 text-xs sm:text-sm">
                ...
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#E8481C]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
