...
const processSteps = [
  {
    ...
    description: 'Click here to upload your plans. Your plans can be Bid set, Schematic, Design Development, Construction document, or conceptual drawings. Following formats are acceptable: .PDF, .TIF, .TIFF, .DXF, .DWF, .DWG, .PLN, .JPG, .JPEG, .CPC, .OSX, .DJVU, .CAL',
    hasButton: true,
  ...
  },
  {
    id: 2,
    title: 'Get a Quote',
    description: 'We will send you a quote consisting of invoice, delivery date, and turnaround time which you can pay via Credit Card or Debit Card or PayPal.',
    hasButton: false,
    isActive: false
  },
  {
    ...
    description: 'Estimates will be delivered to you in EXCEL spreadsheets incorporating all the material and labor pricing either in MasterFormat or the format of your choice.',
    hasButton: false,
    isActive: false
  }
]

export default function CommercialEstimatingHowToStartSection() {
      ...
      <div className="max-w-7xl 2xl:max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 3xl:px-24">
        ...
        <div className="text-center sm:text-left mb-8 sm:mb-10 md:mb-12">
          ...
          <p className="text-xs sm:text-sm md:text-base text-[#121212]/70 max-w-2xl mx-auto sm:mx-0 font-figtree leading-relaxed">
            Our streamlined process ensures you get accurate commercial estimates quickly and efficiently
          </p>
        </div>
            ...
            <div className="relative w-full max-w-sm lg:max-w-md">
              <div className="relative z-10">
                <Image
                  ...
                  alt="Commercial Estimating Process"
                  width={600}
                  height={600}
                ...
                <div className="relative">
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-shrink-0 relative z-10">
                      <div className={`relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full transition-all duration-500 group-hover:scale-110 ${
                        ...
                        <span className={`text-sm sm:text-base font-bold font-figtree transition-colors duration-300 ${
                          step.id === 1 ? 'text-white' : 'text-gray-700 group-hover:text-[#E8481C]'
                        }`}>
                          {step.id}
                        </span>
                    ...
                    <div className="flex-1 pt-0.5 text-center sm:text-left w-full">
                      ...
                      {step.hasButton && step.buttonLink && step.buttonText && (
