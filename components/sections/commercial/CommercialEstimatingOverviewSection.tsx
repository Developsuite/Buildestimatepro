...
export default function CommercialEstimatingOverviewSection() {
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#121212] mb-4 sm:mb-6 font-figtree mx-auto md:mx-0">
              Professional Commercial Construction Estimating
            </h2>
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6 text-sm sm:text-base md:text-lg text-[#121212]/70 leading-relaxed font-figtree mx-auto md:mx-0">
              ...
              <p>
                Our estimators have extensive experience in commercial takeoffs and estimation with a diversified portfolio in North American, the Caribbean, and Australian construction industries including renovation, restoration, addition, and new construction. Each project is reviewed by senior project managers with past experience estimating a substantial commercial portfolio of projects.
              </p>
            </div>
            ...
            <div className="mt-6 sm:mt-8 flex justify-center md:justify-start">
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-[#E8481C] text-white font-figtree font-semibold rounded-sm hover:bg-[#ff6b47] transition-all duration-300 hover:scale-105 shadow-lg text-xs md:text-base"
              >
              ...
              <div className="relative z-10 w-full bg-white/40 backdrop-blur-sm p-4 sm:p-6 rounded-xl border-2 border-white/50 shadow-2xl">
                ...
                <div className="relative rounded-lg overflow-hidden">
                  <Image
                    ...
                    alt="Commercial Construction Estimating"
                    width={600}
                    height={600}
