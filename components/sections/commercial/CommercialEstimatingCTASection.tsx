...
export default function CommercialEstimatingCTASection() {
          ...
          <div className="relative z-10 px-6 sm:px-8 md:px-10 lg:px-12 py-8 sm:py-10 md:py-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 font-figtree leading-tight">
                Ready to Get Started with BuildEstimatePro?
              </h2>
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 leading-relaxed mb-6 sm:mb-8 md:mb-10 font-figtree max-w-2xl mx-auto">
                Many Contractors, Developers, Architects, and Owners trust us for reliable and timely commercial estimating services. We help you achieve your goals whether that involves preparing estimates, setting profit margins, or smartly filing bidding proposals that can set you apart from the competition.
              </p>
