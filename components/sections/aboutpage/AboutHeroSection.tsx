...
export default function AboutHeroSection() {
  ...
  return (
    <section ref={ref} className={`relative w-full h-[280px] sm:h-[320px] md:h-[360px] lg:h-[400px] overflow-hidden scroll-fade-in-up ${isVisible ? 'visible' : ''}`}>
      {/* Background Image */}
      <div 
        ...
        <div className="max-w-7xl 2xl:max-w-[90rem] w-full">
          <div className="max-w-3xl mx-auto md:mx-0 text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 leading-relaxed font-figtree px-2 sm:px-4 md:px-0 mb-4 sm:mb-6 md:mb-8">
              BuildEstimatePro is a trusted construction estimating company serving contractors across the USA with precise, dependable, and timely estimating solutions. We specialize in delivering accurate cost estimates and detailed material takeoffs that help construction professionals bid with confidence and maximize project profitability.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 px-2 md:px-0">
              ...
              >
                <span className="relative z-10 text-sm sm:text-base group-hover:tracking-wide transition-all duration-300">Contact Now</span>
