...
export default function ConstructionEstimatingConsultantOverviewSection() {
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6 text-sm sm:text-base md:text-lg text-[#121212]/70 leading-relaxed font-figtree">
              ...
              <p>
                BuildEstimatePro is a professional cost estimating consulting company with a diverse portfolio of commercial, residential, and industrial projects serving developers, general contractors, subcontractors, architects, home builders, owners, and lenders. Our expert estimators digitally takeoff the quantities using the latest takeoff software and a highly developed construction cost database.
              </p>
              <p>
                We follow the policies and guidelines of certified American estimators organizations like American Association of Cost Engineers (AACE) and the Australian Institute of Quantity Surveyors (AIQS).
              </p>
            </div>
