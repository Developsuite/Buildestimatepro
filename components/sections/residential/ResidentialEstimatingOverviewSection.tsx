        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center text-center md:text-left">
            ...
            <div className="mt-6 sm:mt-8 flex justify-center md:justify-start">
              <Link
                href="/samples"
                className="group inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-[#E8481C] text-white font-figtree text-xs md:text-base font-semibold rounded-sm hover:bg-[#ff6b47] transition-all duration-300 hover:scale-105 shadow-lg"
              >
