...
export default function IndustrialEstimatingOverviewSection() {
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#121212] mb-4 sm:mb-6 font-figtree">
              Professional Industrial Construction Estimating
            </h2>
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6 text-sm sm:text-base md:text-lg text-[#121212]/70 leading-relaxed font-figtree">
              <p>
                BuildEstimatePro has been rendering total estimating solutions to EPC contractors, owners, engineering firms, financial investors, and joint venture partners in the North American industrial sector. Our wide range of industrial estimating services is tailored to the specific needs of the respective clients starting from project planning, through conception and construction.
              </p>
              <p>
                Our approach to precise estimating procedures gained from experience and proficiency in the latest technology, helps them anticipate, plan, and effectively control cost throughout the entire lifecycle of the project.
              </p>
            </div>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link
                href="/contact"
                className="group inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#E8481C] text-white font-figtree font-semibold rounded-sm hover:bg-[#ff6b47] transition-all duration-300 hover:scale-105 shadow-lg"
              >
                Schedule a Meeting
              ...
              <Link
                href="/contact"
                className="group inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/80 text-[#121212] font-figtree font-semibold rounded-sm hover:bg-white transition-all duration-300 hover:scale-105 shadow-lg border border-[#121212]/10"
              >
                Upload Plans
                <svg className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="relative w-full max-w-md lg:max-w-lg flex items-center">
              ...
              <div className="relative z-10 w-full bg-white/40 backdrop-blur-sm p-4 sm:p-6 rounded-xl border-2 border-white/50 shadow-2xl">
                ...
                <div className="relative rounded-lg overflow-hidden">
                  <Image
                    src="/images/home/industrial.png"
                    alt="Industrial Construction Estimating"
                    width={600}
                    height={600}
