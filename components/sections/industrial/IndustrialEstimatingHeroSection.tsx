...
export default function IndustrialEstimatingHeroSection() {
  ...
  return (
    <section ref={ref} className={`relative w-full h-[350px] sm:h-[380px] md:h-[420px] lg:h-[450px] overflow-hidden scroll-fade-in-up ${isVisible ? 'visible' : ''}`}>
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/images/home/industrial.png')" }}
      >
        ...
        <div className="max-w-7xl 2xl:max-w-[90rem] w-full">
          <div className="max-w-3xl mx-auto md:mx-0 text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 leading-relaxed font-figtree px-2 sm:px-4 md:px-0 mb-4 sm:mb-6 md:mb-8">
              Get our Industrial estimating services to save estimating costs and improve accuracy. Have your estimates and takeoffs audited and analyzed by professional construction estimators within the fastest turnaround times.
            </p>
