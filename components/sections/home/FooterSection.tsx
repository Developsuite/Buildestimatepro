      ...
      <div className="max-w-7xl 2xl:max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 3xl:px-24">
        ...
        <div className="py-12 sm:py-16 md:py-20 lg:py-24">
          ...
          <div className="text-center sm:text-left mb-8 sm:mb-12">
            ...
            <p className="text-xs sm:text-sm text-white/70 leading-relaxed font-figtree max-w-md mx-auto sm:mx-0">
              Professional construction estimating services to help you bid confidently and manage project costs effectively.
            </p>
          </div>

          {/* 2 Column Layout for Mobile, 3 Columns for Desktop */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-8 sm:gap-10 md:gap-12">
            {/* Quick Links */}
            ...
            <div className="col-span-2 sm:col-span-1 space-y-4 sm:space-y-5">
              <h4 className="text-base sm:text-lg font-bold font-figtree mb-4 sm:mb-6 text-center sm:text-left">
                Contact Us
              </h4>
              <ul className="grid grid-cols-1 sm:grid-cols-1 gap-3 sm:gap-4">
                <li className="flex items-start gap-3 justify-center sm:justify-start">
                  ...
                  <a href="mailto:info@constructestimates.com" className="text-xs sm:text-sm text-white/70 hover:text-[#E8481C] transition-colors duration-300 font-figtree break-all">
        ...
        <div className="border-t border-white/10 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            <p className="text-xs sm:text-sm text-white/60 font-figtree text-center sm:text-left">
              © {new Date().getFullYear()} Buildestimatepro. All rights reserved.
            </p>
