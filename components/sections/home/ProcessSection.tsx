...
const processSteps = [
  {
    ...
    description: 'You can easily upload your drawing plans in various formats including PDF files through our user-friendly platform, contact page or simply email us at info@constructestimates.com. We value your convenience, so feel free to choose the method that works best for you. Don\'t forget to provide us with essential information about your project scope and any specific details by filling out the form.',
    hasButton: false,
    isActive: true
  },
  {
  ...
  },
  {
    id: 3,
    title: 'Get A Quote',
    description: 'Receive a detailed, transparent quote that breaks down all costs, materials, and labor requirements. Our competitive pricing helps you make informed decisions.',
    hasButton: false,
    isActive: false
  },
  {
...
export default function ProcessSection() {
  ...
  return (
    <section ref={ref} className={`w-full pt-0 pb-16 sm:pb-20 md:pb-24 lg:pb-28 xl:pb-32 bg-[#F5F1E6] scroll-fade-in-up ${isVisible ? 'visible' : ''}`}>
