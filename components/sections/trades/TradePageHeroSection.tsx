...
interface TradePageHeroSectionProps {
  data: {
    title: string
    description: string
...
export default function TradePageHeroSection({ data, title }: TradePageHeroSectionProps) {
        ...
        <div className="max-w-7xl 2xl:max-w-[90rem] w-full">
          <div className="max-w-3xl mx-auto md:mx-0 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 px-2 md:px-0">
              ...
              >
                <span className="relative z-10 text-sm sm:text-base group-hover:tracking-wide transition-all duration-300">Get Free Quote</span>
              ...
              >
                <span className="relative z-10 text-sm sm:text-base group-hover:tracking-wide transition-all duration-300">Learn More</span>
