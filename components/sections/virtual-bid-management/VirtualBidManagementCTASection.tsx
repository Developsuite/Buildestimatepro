...
export default function VirtualBidManagementCTASection() {
          ...
          <div className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10 md:py-12 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 font-figtree leading-tight">
                Your Solution with Our <span className="text-[#E8481C]">Virtual Bid Manager</span>
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-6 sm:mt-8">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm text-white/80 font-figtree">Expert Guidance</span>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm text-white/80 font-figtree">Flexible Pricing</span>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm text-white/80 font-figtree">Proven Results</span>
                </div>
              </div>
            </div>
          </div>
