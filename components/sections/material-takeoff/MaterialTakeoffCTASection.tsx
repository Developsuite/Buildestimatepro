...
export default function MaterialTakeoffCTASection() {
          ...
          <div className="relative z-10 px-6 sm:px-8 md:px-10 lg:px-12 py-8 sm:py-10 md:py-12">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 font-figtree leading-tight">
                Quantify Material Takeoffs With Our Expert Assistance!
              </h2>
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 leading-relaxed mb-6 sm:mb-8 md:mb-10 font-figtree max-w-2xl mx-auto">
                Every construction project needs 100% precise and accurate quantity/material takeoffs. If you are searching for a reliable option to get services, BuildEstimatePro is the best choice. We will understand your project scope and then create a takeoff sheet accordingly. Our team will leave nothing that can cause issues during the building process. Get estimates today!
              </p>
