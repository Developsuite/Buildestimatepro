        ...
        <div className="max-w-7xl 2xl:max-w-[90rem] w-full">
          <div className="max-w-3xl mx-auto md:mx-0 text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 leading-relaxed font-figtree px-2 sm:px-4 md:px-0 mb-4 sm:mb-6 md:mb-8">
              Expert construction estimating and material takeoff services for contractors, builders, and construction professionals. We deliver accurate, reliable, and cost-effective estimates that help you win more bids and stay within budget. From residential to commercial and industrial projects, our experienced team provides comprehensive estimating solutions tailored to your needs.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 px-2 md:px-0">
              ...
              >
                <span className="relative z-10 text-sm sm:text-base group-hover:tracking-wide transition-all duration-300">Get Free Estimate</span>
              ...
              >
                <span className="relative z-10 text-sm sm:text-base group-hover:tracking-wide transition-all duration-300">Contact Our Experts</span>
